      ...
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-black/65 backdrop-blur-xl">
        <div className="mx-auto flex min-h-[72px] max-w-7xl items-center justify-between px-5 py-3 sm:px-8">
          <a href="#home" className="group">
            ...
            <div className="mt-0.5 hidden text-[9px] font-semibold tracking-[0.08em] text-white/50 sm:block">
      ...
      <section id="home" className="scroll-mt-24 relative flex min-h-[620px] items-center px-5 pb-12 pt-24 sm:min-h-[680px] sm:px-8 sm:pb-14 lg:min-h-[680px] lg:pt-24 lg:pb-14">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_.9fr] lg:gap-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-white/60 sm:mt-7 sm:text-xl sm:leading-8">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[.035] p-6 sm:p-9">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl bg-white/[.04] p-5">
                <div className="text-[11px] font-semibold uppercase tracking-[.18em] text-white/45">Location</div>
                <div className="mt-2 font-semibold">Shara-e-Zarghoon</div>
              </div>
              <div className="rounded-2xl bg-white/[.04] p-5">
                <div className="text-[11px] font-semibold uppercase tracking-[.18em] text-white/45">Hours</div>
            ...
            <div className="grid lg:grid-cols-[1.3fr_.7fr]">
              <div className="p-7 sm:p-10 lg:p-14">
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <div className="text-[11px] font-semibold uppercase tracking-[.18em] text-white/45">Open Daily</div>
      ...
      <section id="contact" className="scroll-mt-24 border-t border-white/10 px-5 py-20 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-4 sm:gap-5 md:grid-cols-3">
            ...
            >
              <div className="text-[11px] font-semibold uppercase tracking-[.2em] text-white/45">Mobile</div>
              <div className="mt-4 text-2xl font-black">03337844515</div>
              <div className="mt-2 text-[14px] font-semibold tracking-[.02em] text-[#fbcf24]">Call Now →</div>
            </a>

            <div className="rounded-3xl border border-white/10 bg-white/[.04] p-6 sm:p-7">
              <div className="text-[11px] font-semibold uppercase tracking-[.2em] text-white/45">Landline</div>
            ...
            >
              ...
              <div className="mt-4 text-2xl font-black">03337844515</div>
              <div className="mt-2 text-[14px] font-semibold tracking-[.02em] text-[#fbcf24]">Message Us →</div>
            </a>
          </div>
        </div>
      </section>
