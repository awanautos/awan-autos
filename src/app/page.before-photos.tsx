...
const services = [
  ...
  ["02", "Diesel", "Reliable fuel for every journey."],
  ["03", "Engine Oil & Lubricants", "Trusted care for smoother engine performance."],
  ["04", "Car Wash", "Professional care for a cleaner vehicle."],
